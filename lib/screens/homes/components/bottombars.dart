            ...
            children: [
              Row(
                children: [
                  Icon(
                    Icons.radar_sharp,
                    size: currentWidth <= 400 ? 30.0 : 45.0,
                  ...
                  Container(
                    ...
                    child: Text(
                      'ShopFood',
                      style: TextStyle(
                          fontSize: currentWidth <= 400 ? 20.0 : 35.0,
                          color: Colors.indigo[600],
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'support@shopfood.com',
                        style: TextStyle(
                          fontSize: currentWidth <= 400 ? 12 : 15.0,
                          color: Colors.grey,
                        ),
                      ),
                    ),
              ...
              Container(
                padding: EdgeInsets.only(
                    left: 08.0, top: currentWidth <= 400 ? 10.0 : 20.0),
                child: Row(
                  children: [
              ...
              Container(
                padding: EdgeInsets.only(
                    left: 10.0, top: currentWidth <= 400 ? 10.0 : 20.0),
                child: Row(
                  children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.facebook,
                        color: Colors.indigo,
                        size: currentWidth <= 400 ? 15.0 : 20.0),
                    Padding(
                      padding: EdgeInsets.only(left: 05.0),
                      child: Text(
                        'Facebook',
