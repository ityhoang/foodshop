...
class _ContentsState extends State<Contents> {
          ...
          SizedBox(
              ...
              child: ScrollConfiguration(
                ...
                child: StreamBuilder<List<UserModel>>(
                  stream: productProvider.getUserList().asStream(),
  ...
  Widget showproduct(UserModel e) {
    return Padding(
                          ...
                          onTap: () {
                            setState(() {
                              FluroRouters.router.navigateTo(
                                  context, ViewbillScreen.routeName,
                                  routeSettings: RouteSettings(
                                      arguments: ViewbillArguments(id: e.id)),
                                  replace: true);
                            });
                          },
                          child: Icon(
